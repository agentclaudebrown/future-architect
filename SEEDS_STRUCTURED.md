...
> **Why it is here:** THE FRAME. Read before anything else. Corrects the thesis statement itself — closes the "so what does AI actually change" gap. Principles persist; methodology must be rebuilt; here are the five constraints AI removes.

## A0 · [SEC 38] THE FRAME CORRECTION — What AI Actually Changes (FOUNDATIONAL — corrects the thesis statement itself)
...
## HS1 · [SEC 37] The Historical Spine — Systems, Defined Roles, and What Survives a Substrate Change (MAJOR — v2, rewritten)
